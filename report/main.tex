...
\IEEEauthorblockA{Department of Automation\\
SUSTech\\
Email: pengjw@example.edu}
\and
\IEEEauthorblockN{Han Yang}
\IEEEauthorblockA{Department of Automation\\
SUSTech\\
Email: yangh@example.edu}
\and
\IEEEauthorblockN{Ziling Lu}
\IEEEauthorblockA{Department of Automation\\
SUSTech\\
Email: luzl@example.edu}
}
...
Alternative robust approaches include sliding-mode control~\cite{utkin2013},
...
\begin{figure}[t]
  ...
  \caption{Trajectory tracking under piecewise disturbance (S3). LQR (blue)
  vs.\ LQR+DOB (orange); reference (dashed black). The DOB trace stays
  consistently closer to the reference circle.}
  \label{fig:traj-pw}
\end{figure}
